                ...
                <div class="col-sm-8 col-xs-12">
                    <form id="setpass" method="POST" action="api/Users.php?f=setpass">
                        <div class="form-group pass">
                            <label for="pass">Establecer contraseña</label>
                            <input type="password" class="form-control" id="pass_ppal" placeholder="Introduce tu contraseña(sin restricciones)">
                        </div>
                        <div class="form-group pass-rep">
                            <input type="password" class="form-control" id="pass-rep_ppal" placeholder="Repite tu contraseña">
                        </div>
